...
VALUES
  ...
  (
    ...
    'easy',
    ARRAY['algorithms', 'dynamic-programming'],
    ARRAY['javascript', 'python', 'java', 'cpp'],
    '{"javascript": "function fib(n) {\n  // Your code here\n}", "python": "def fib(n):\n    # Your code here\n    pass", "java": "class Solution {\n    public int fib(int n) {\n        // Your code here\n    }\n}", "cpp": "class Solution {\npublic:\n    int fib(int n) {\n        // Your code here\n    }\n};"}',
    '[{"input": "2", "expected_output": "1"}, {"input": "3", "expected_output": "2"}, {"input": "4", "expected_output": "3"}, {"input": "30", "expected_output": "832040"}]',
    '{"javascript": "function fib(n) {\n  if (n <= 1) return n;\n  let a = 0, b = 1;\n  for (let i = 2; i <= n; i++) {\n    let c = a + b;\n    a = b;\n    b = c;\n  }\n  return b;\n}", "python": "def fib(n):\n    if n <= 1:\n        return n\n    a, b = 0, 1\n    for i in range(2, n + 1):\n        c = a + b\n        a = b\n        b = c\n    return b", "java": "class Solution {\n    public int fib(int n) {\n        if (n <= 1) return n;\n        int a = 0, b = 1;\n        for (int i = 2; i <= n; i++) {\n            int c = a + b;\n            a = b;\n            b = c;\n        }\n        return b;\n    }\n}", "cpp": "class Solution {\npublic:\n    int fib(int n) {\n        if (n <= 1) return n;\n        int a = 0, b = 1;\n        for (int i = 2; i <= n; i++) {\n            int c = a + b;\n            a = b;\n            b = c;\n        }\n        return b;\n    }\n};"}',
    ARRAY['Try using dynamic programming to avoid redundant calculations', 'You can use an iterative approach with two variables to store the previous two Fibonacci numbers', 'Be careful with the base cases: F(0) = 0 and F(1) = 1']
  );
...
VALUES
  ...
  (
    ...
    'Learn the fundamentals of data structures and algorithms, including arrays, linked lists, stacks, queues, trees, and graphs.',
    'data-structures-and-algorithms',
    'intermediate',
    'algorithms',
    ARRAY['algorithms', 'data-structures', 'programming'],
    'https://example.com/images/data-structures-and-algorithms.jpg',
    20
  );
...
VALUES
  ...
  (
    (SELECT id FROM courses WHERE slug = 'javascript-fundamentals'),
    'Functions and Scope',
    'Learn about functions, parameters, return values, and scope in JavaScript.',
    3
  ),
  (
    (SELECT id FROM courses WHERE slug = 'javascript-fundamentals'),
    'Control Flow',
    'Learn about conditional statements, loops, and error handling in JavaScript.',
    4
  );
...
VALUES
  ...
  (
    ...
    'Let\'s write your first JavaScript program! Open your text editor and create a new file called index.html. Add the following code:\n\n```html\n<!DOCTYPE html>\n<html>\n<head>\n  <title>My First JavaScript Program</title>\n</head>\n<body>\n  <h1>Hello, World!</h1>\n  <script>\n    console.log("Hello, World!");\n  </script>\n</body>\n</html>\n```\n\nSave the file and open it in your web browser. Open the browser\'s developer console (usually by pressing F12 or right-clicking and selecting "Inspect"), and you should see the message "Hello, World!" in the console.',
    3,
    'text',
    20
  );
